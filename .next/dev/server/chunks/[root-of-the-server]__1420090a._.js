...
"[project]/Documents/seat - reservation/src/app/api/reports/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        if (reportType === 'summary') {
            // Overall statistics
            const totalSeats = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$seat__$2d$__reservation$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].seat.count();
            const totalReservations = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$seat__$2d$__reservation$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].reservation.count({
                where: {
                    status: 'ACTIVE'
                }
            });
            const today = new Date().toISOString().split('T')[0];
            const todayReservations = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$seat__$2d$__reservation$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].reservation.count({
                where: {
                    date: today,
                    status: 'ACTIVE'
                }
            ...
            // Most popular seats
            const seatUsage = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$seat__$2d$__reservation$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].reservation.groupBy({
                by: [
                    'seatId'
                ],
                where: {
            ...
            const popularSeats = await Promise.all(seatUsage.map(async (item)=>{
                const seat = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$seat__$2d$__reservation$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].seat.findUnique({
                    where: {
                        id: item.seatId
                    }
                });
            ...
            const trends = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$seat__$2d$__reservation$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].reservation.groupBy({
                by: [
                    'date'
                ],
                where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1420090a._.js.map